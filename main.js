...
Module['FS_createPath']('/', 'shaders', true, true);
 ...
 loadPackage({"files": [{"start": 0, "audio": 0, "end": 4043, "filename": "/models/cube_m.json"}, {"start": 4043, "audio": 0, "end": 7237, "filename": "/assets/multi.bmp"}, {"start": 7237, "audio": 0, "end": 7501, "filename": "/shaders/simple.es300.vert"}, {"start": 7501, "audio": 0, "end": 7768, "filename": "/shaders/simple.es300.frag"}], "remote_package_size": 7768, "package_uuid": "c004ec36-6d9a-41bc-8014-306ed9e41212"});
...
STATICTOP = STATIC_BASE + 78224;
/* global initializers */  __ATINIT__.push({ func: function() { __GLOBAL__I_000101() } }, { func: function() { __GLOBAL__sub_I_main_cpp() } }, { func: function() { ___emscripten_environ_constructor() } }, { func: function() { __GLOBAL__sub_I_iostream_cpp() } });
...
// {{PRE_LIBRARY}}
  ...
  function _my_other_func() {
  err('missing function: my_other_func'); abort(-1);
  }
...
Module['wasmTableSize'] = 44288;

Module['wasmMaxTableSize'] = 44288;
...
var real__toggle_background_color = asm["_toggle_background_color"]; asm["_toggle_background_color"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real__toggle_background_color.apply(null, arguments);
};
...
var _toggle_background_color = Module["_toggle_background_color"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["_toggle_background_color"].apply(null, arguments) };
